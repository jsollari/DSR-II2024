...
b\) Calculate a confusion matrix by hand to the model that considers the steps of the recipe in the workflow. Which probability threshold was used for predicting the classes? 
```{r 2_5_2_modelling}
